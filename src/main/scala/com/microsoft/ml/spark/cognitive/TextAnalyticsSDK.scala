...
case class SentimentScoredDocumentV4(sentiment: String,
                                     confidenceScorePos: Double,
                                     confidenceScoreNeutral: Double,
                                     confidenceScoreNeg: Double)
...
//                    length: Int)
//
//case class SentimentScoreV4(positive: Double, neutral: Double, negative: Double)
